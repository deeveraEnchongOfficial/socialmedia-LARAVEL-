$(window).on("load", function() {
    ...
    $(".post-project > a").on("click", function(){
        ...
        //  ============= Cover Image POPUP FUNCTION =========

        $(".post-cover").on("click", function(){
            $(".post-popup.cover_post").addClass("active");
            $(".wrapper").addClass("overlay");
            return false;
        });
        $(".post-project > a").on("click", function(){
            $(".post-popup.cover_post").removeClass("active");
            $(".wrapper").removeClass("overlay");
            return false;
        });

                //  ============= Profile Image POPUP FUNCTION =========

                $(".post-profile").on("click", function(){
                    $(".post-popup.profileImg_post").addClass("active");
                    $(".wrapper").addClass("overlay");
                    return false;
                });
                $(".post-project > a").on("click", function(){
                    $(".post-popup.profileImg_post").removeClass("active");
                    $(".wrapper").removeClass("overlay");
                    return false;
                });
