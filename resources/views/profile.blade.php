...
<div class="wrapper">
    ...
    <section class="cover-sec">
        <img src="images/Profile/{{ Auth::user()->cover_image }}" alt="" width="1600" height="400">
        <a class="post-cover" href="#" title=""><i class="fa fa-camera"></i> Change Image</a>
    </section>
                            ...
                            <div class="main-left-sidebar">
                                <div class="user_profile">
                                    <div class="user-pro-img">
                                        <img src="images/Profile/{{ Auth::user()->profile_image }}" alt="" width="170" height="170">
                                        <a class="post-profile" href="#" title=""><i class="fa fa-camera"></i></a>
    ...
    <div class="post-popup cover_post">
                ...
                <form action="{{ route('profile.update', Auth::user()->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-lg-12 pb-3">
                            <img src="images/Profile/{{ Auth::user()->cover_image }}" alt="" width="500" height="250">
                        </div>
    ...
    <div class="post-popup profileImg_post">
        <div class="post-project">
            <h3>Profile Image</h3>
            <div class="post-project-fields">
                <form action="{{ route('profile.update', Auth::user()->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-lg-12 pb-3 d-flex justify-content-center">
                            <img src="images/Profile/{{ Auth::user()->profile_image }}" alt="" width="300" height="300">
                        </div>
                        
                        <div class="col-lg-12">
                            <input type="file" name="profile_image" value="images/Profile/{{ Auth::user()->profile_image }}">
                        </div>
